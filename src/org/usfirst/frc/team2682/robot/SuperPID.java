 ...
 * PIDOutput
 */
public class SuperPID implements  LiveWindowSendable{
    ...
    private class PIDTask extends TimerTask {
        ...
        private SuperPID m_controller;

        public PIDTask(SuperPID controller) {
            if (controller == null) {
     ...
     */
    public SuperPID(double Kp, double Ki, double Kd, double Kf,
     ...
     * @param period 
     */
    public SuperPID(double Kp, double Ki, double Kd,
            PIDSource source, PIDOutput output,
            double period) {
